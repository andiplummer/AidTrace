...
const posts = [
  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/World_Food_Programme_Logo_Simple.svg/200px-World_Food_Programme_Logo_Simple.svg.png"
  },

  {
    ...
    image:
      "https://upload.wikimedia.org/wikipedia/en/c/c2/All_Hands_And_Hearts_-_Smart_Response_new_logo_%282018%29.png"
  },

  {
    ...
    image:
      "https://i1.wp.com/www.directrelief.org/wp-content/uploads/Direct-Relief-Logo-Square-Full.png?w=1192&crop=0%2C0px%2C100%2C1189px&ssl=1"
  },
...

  {
    ...
    image:
      "https://over50andoverseas.com/wp-content/uploads/2018/11/habitat-for-humanity-logo.jpg"
  },

  {
    ...
    image:
      "https://bloximages.newyork1.vip.townnews.com/mcdowellnews.com/content/tncms/assets/v3/editorial/2/a6/2a662eaa-a34e-11e9-8752-1f55e33a45f3/5d26453489900.image.jpg?resize=400%2C400"
  }
];
        ...
        {posts.map(post => (
          ...
          <Card id="card">
            ...
            <CardActions class="card-actions">
              ...
              {/* <Icon icon={ethereumIcon} onClick={this.modalVisible} class="ethereum-icon" /> */}
            </CardActions>
          </Card>
          // </Grid>
        ))}
